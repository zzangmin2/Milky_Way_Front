...
const ArticleDetail = () => {
  ...
  const dummyData: any = {
    ...
    articleType: "study",
    articleTitle: "더미 데이터로 채워진 게시물",
    articleContent: "이곳에는 더미 데이터가 들어갑니다.",
    articleLikes: 10,
    articleApply: 20,
    articleApplyNow: 5,
    articleStartDay: "2024-05-01",
    articleEndDay: "2024-05-31",
    articleRecruitmentState: true,
    articleMentorNeeded: true,
    articleMentorTag: "#더미 #멘토",
    articleApplyState: [
      {
        id: 1,
        applicantName: "김복이",
  ...
  useEffect(() => {
    ...
    setArticleCurrentState(dummyData);
  }, []);
